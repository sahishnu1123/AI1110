...
\hhline{|---|~}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\centering}\gnumbox{$\angle PSR$ ($\alpha$)}}
	&\multicolumn{1}{p{\gnumericColB}|}%
...
\hhline{|---|~}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\centering}\gnumbox{$\angle QPS$ ($\beta$)}}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}\gnumbox{input}}
	&\multicolumn{1}{p{\gnumericColC}|}%
...
\hhline{|---|~}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\centering}\gnumbox{$\angle SQP$ ($\gamma$)}}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}\gnumbox{input}}
	&\multicolumn{1}{p{\gnumericColC}|}%
...
\hhline{|---|~}
	...
	{\gnumericPB{\centering}\gnumbox{output}}
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\centering}\gnumbox\extrarowheight{2$\alpha$ = $164^o$}}
	&
\\
\hhline{|---|~}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	...
	{\gnumericPB{\centering}\gnumbox{output}}
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\centering}\gnumbox\extrarowheight{2$\gamma$ = $110^o$}}
	&
\\
\hhline{|-|-|-|~}
\end{tabular}
